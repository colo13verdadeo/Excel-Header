        ...
        <nav id='headerToolBar'>
            ...
            <section id='SeccionMain'>
                <div className={Carousel == 1 ? "secccion1 Sopen" : "secccion1"}>
                    ...
                    <img src="/svg/tigeras.svg" title='Cortar' className="sec_img3Copiar"></img>
                    <span className='sec_span3Cortar'>Cortar</span>
                    <img src="/svg/papel.svg"  title='Copiar' className="sec1_img4Copiar"></img>
                    <img src="/svg/paste.svg"  title='Copiar como imagen' className="sec1_img5Copiar"></img>
